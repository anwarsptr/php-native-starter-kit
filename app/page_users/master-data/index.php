...
$id_menu_parent = 7;
$active = 1;
$result = getMenuIndex($role_id, $position, $id_menu_parent, $active);
...
<section class="content-header">
  <h1> <i class="fa fa-puzzle-piece"></i> <?= $title ?> <small></small>
  </h1>
  <ol class="breadcrumb">
    <li>
      <a href="dashboard"> <i class="fa fa-dashboard"></i> Dashboard </a>
    </li>
    <li class="active"> <i class="fa fa-puzzle-piece"></i> <?= $title ?></li>
  </ol>
</section>
